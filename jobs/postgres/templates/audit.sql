...
-- CREATE EXTENSION IF NOT EXISTS hstore; -- not worigin pg 9.0
...
BEGIN
    ...
    THEN
      ...
      -- Roles defines in deployment manifest should have access to audit schema. 
...
BEGIN
  IF NOT EXISTS(
    SELECT table_name
              ...
              WHERE table_name = 'logged_actions' AND table_schema = 'audit'
    )
  THEN
    ...
    -- Roles defined in deoployment manifest should have access to audited data. 
