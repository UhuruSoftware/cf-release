module Uhuru::BoshCommander
  class AppcloudngForm < GenericForm

    PRODUCT_NAME = "appcloudng"
    ...
    def auto_complete_manifest!
      ...
      properties.set_val 'vcap_postgres',              'address',                    jobs.find_by_name('vcap_postgres')['networks'][0]['static_ips'][0]
    ...
    def self.from_imported_data(cloud_name, imported_data)
      ...
      AppcloudngForm.new(saved_data, nil, Deployment.new(cloud_name, PRODUCT_NAME))
    end
    ...
    def self.from_cloud_name(cloud_name, form_data)
      ...
      AppcloudngForm.new(saved_data, form_data, Deployment.new(cloud_name, PRODUCT_NAME))
    end
    ...
    def upgrade
      ...
      @saved_data = AppcloudngUpgrade.upgrade @saved_data, new_manifest
    ...
    def initialize(saved_data, form_data, deployment)
      ...
      super('appcloudng', saved_data, form_data, live_data)
    end
  end
end
